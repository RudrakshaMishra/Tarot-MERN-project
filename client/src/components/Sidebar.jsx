...
const Sidebar = () => {
  ...
  // Fixed the comma error to a period and added optional chaining
      ...
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
          ...
          <div className="relative py-2 group">
            <img src={assets.Menu} alt="menu" className='max-h-15 cursor-pointer' />
      ...
      <div className='flex flex-col'>
        {filteredUsers?.map((user, index) => (
          <div onClick={() => { setSelectedUser(user); setUnseenMessages(prev => ({ ...prev, [user._id]: 0 })) }}
            ...
            <img src={user?.profilePic || assets.default_avater} alt="" className='w-[35px] aspect-[1/1] rounded-full' />
